...
# !!! Main.UserApp is configured as an alias for Main.SheetGantt and you might encounter it in some tests
using Main.SheetGantt, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "SheetGantt tests" begin
  @includetests ARGS
end
